 ...
 * @Package ${basePackagePojoDataTransferObject}
 * @author: ${author}
 * @date:   ${date}
 * @version V1.0
...
import ${dataTransferObjectPackage};
...
* @date ${date}
*/
public class ${modelNameUpperCamel}DTO extends RequestDTO implements Serializable {
