...
import com.jensen.platform.crm.api.common.bean.JwtAuthToken;
import com.jensen.platform.crm.api.common.utils.JWTTokenUtils;
...
public class JWTLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        JwtAuthToken token = new JwtAuthToken(null, null, JWTTokenUtils.generateToken(authResult));
